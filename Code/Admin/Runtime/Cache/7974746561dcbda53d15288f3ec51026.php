...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="__PUBLIC__/skin/images/tbg.gif">&nbsp;二级分类列表&nbsp;</td>
</tr>
...
<?php if($list): if(is_array($list)): foreach($list as $key=>$vo): ?><tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><?php echo ($vo["name"]); ?></td>
        <td><a href="?s=Cate2/edit&id=<?php echo ($vo["id"]); ?>&pid=<?php echo ($vo["pid"]); ?>">编辑</a> | <a href="?s=Cate2/del&id=<?php echo ($vo["id"]); ?>&pid=<?php echo ($vo["pid"]); ?>">删除</a></td>
...
<table width="300px" bgcolor="FCFDEE"  align="center" border="0px">
    <form  action="?s=Cate2/insert" method="post">
        <input type="hidden" name="pid" value="<?php echo ($id); ?>">
    <tr><td colspan="2">添加新的二级分类</td></tr>
    <tr><td>分类名称</td><td><input type="text" name="cate2"></td></tr>
