...
<title>top</title>
<link href="__PUBLIC__/skin/css/base.css" rel="stylesheet" type="text/css">
...
{
  text-align:center;
	background:url(__PUBLIC__/skin/images/frame/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="__PUBLIC__/skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="__PUBLIC__/skin/images/frame/logo.gif" /></td>
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	...
        	[<a href="?s=Index/logout" target="_top">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
